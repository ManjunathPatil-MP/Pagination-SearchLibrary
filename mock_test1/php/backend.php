<?php
	...
	require_once('C:/xampp/htdocs/Mock_test_1/search_library/search.php');// Changes added by Manjunath
	require_once('C:/xampp/htdocs/Mock_test_1/pagination1.0/prepared_query.php');// Changes added by Manjunath
	...
	{   
	    ...
	    $keys=array('type','table_name','search_col_name','get_colms','get_id');// Changes added by Manjunath
	    $value=array(array('string','mock_test_tbl','Email','Id,Name,Email,Phone,Gender','Id'));// Changes added by Manjunath
	    $query_data=array();
		...
		$tble1= $where_data; // Changes added by Manjunath
		if($tble1=='')
	    {
	        $total_data=array();
